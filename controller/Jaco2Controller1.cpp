...
class Jaco2Controller1 : public SimpleController
{
    Body* body;
    double dt;
...
bool Jaco2Controller1::initialize(SimpleControllerIO* io)
{
    body = io->body();
    dt = io->timeStep();
...
bool Jaco2Controller1::initializeJoints(SimpleControllerIO* io, vector<JointSpec>& specs, const string& prefix)
{
    for(auto& spec : specs){
        JointInfo info;
...
void Jaco2Controller1::updateTargetJointAngles()
{
...
void Jaco2Controller1::setTargetJointAngle(int jointID, Joystick::AxisID stickID, double k)
{
...
void Jaco2Controller1::setTargetJointAngle(int jointID, Joystick::ButtonID button1, Joystick::ButtonID button2, double k)
{
...
void Jaco2Controller1::setFingerTargetJointAngles()
{
...
void Jaco2Controller1::clampTargetJointAngle(int jointID)
{
...
void Jaco2Controller1::controlJointsWithPosition()
{
...
void Jaco2Controller1::controlJointsWithVelocity()
{
    for(auto& info : jointInfos){
        auto joint = info.joint;
        double q = joint->q();
...
void Jaco2Controller1::controlJointsWithTorque()
{
    for(auto& info : jointInfos){
        auto joint = info.joint;
        double q = joint->q();
...
CNOID_IMPLEMENT_SIMPLE_CONTROLLER_FACTORY(Jaco2Controller1)
