...
class Jaco2Controller2 : public SimpleController
{
    Body* body;
    double dt;
...
bool Jaco2Controller2::initialize(SimpleControllerIO* io)
{
    body = io->body();
    dt = io->timeStep();
...
bool Jaco2Controller2::initializeJoints(SimpleControllerIO* io, vector<JointSpec>& specs, const string& prefix)
{
    for(auto& spec : specs){
        JointInfo info;
...
void Jaco2Controller2::updateTargetJointAngles()
{
...
void Jaco2Controller2::setTargetJointAngle(int jointID, Joystick::AxisID stickID, double k)
{
...
void Jaco2Controller2::setTargetJointAngle(int jointID, Joystick::ButtonID button1, Joystick::ButtonID button2, double k)
{
...
void Jaco2Controller2::setFingerTargetJointAngles()
{
...
void Jaco2Controller2::clampTargetJointAngle(int jointID)
{
...
void Jaco2Controller2::controlJointsWithPosition()
{
...
void Jaco2Controller2::controlJointsWithVelocity()
{
    for(auto& info : jointInfos){
        auto joint = info.joint;
        double q = joint->q();
...
void Jaco2Controller2::controlJointsWithTorque()
{
    for(auto& info : jointInfos){
        auto joint = info.joint;
        double q = joint->q();
...
CNOID_IMPLEMENT_SIMPLE_CONTROLLER_FACTORY(Jaco2Controller2)
